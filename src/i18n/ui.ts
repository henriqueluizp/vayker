...
export const ui = {
  pt: {
    ...
    'footer.statusLine': 'Em desenvolvimento',
    'footer.statusSub': 'App Store e Google Play em breve.',
  ...
  en: {
    ...
    'footer.status': 'Status',
    'footer.statusLine': 'In development',
    'footer.statusSub': 'App Store and Google Play coming soon.',
